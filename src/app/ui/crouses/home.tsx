...
const Home:React.FC<HomeProps> = ({bgimage,title,description})=> {
  return (
    <div className='flex justify-around'>
       ...
       <div className='bg-zinc-700'>
              ...
              <Link href="#" className='bg-lime-500 shadow-lg shadow-lime-500/50 hover:shadow-xl  py-2 px-3 rounded-lg m-2 mt-8 font-semibold text-white'>Enroll now </Link>
       </div>
