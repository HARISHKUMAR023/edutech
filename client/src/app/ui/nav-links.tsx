    ...
    <>
      {links.map((link) => {
        ...
        return (
          ...
          <li key={link.name} >
             <Link href={link.href} 
             className={clsx('flex items-center p-3 pl-0  my-6 mx-6 text-white dark:text-white hover:border-b hover:border-lime-400 hover:text-lime-400 dark:hover:bg-gray-700  group',
